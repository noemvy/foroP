...
<template>
    ...
    <div class="p-2 w-full">
        <div class="font-extrabold flex items-center justify-between mt-0.5 mb-1.5">
            ...
            <div class="flex items-center">
                <MapMarker fillColor="#5e5c5c" :size="18" />
                <span class="font-[300] text-[15px] text-gray-500 pl-2">{{ tweet.location }}</span>
                <div class="hover:bg-sky-800 rounded-full cursor-pointer relative ml-2">
                    ...
                    <ul class="p-3">
                        <Link
                            as="button"
                            method="delete"
                            :href="route('dashboard.destroy', { id: tweet.id })"
        ...
        <div class="flex">
                <Tag fillColor="#22d3ee" :size="18" />
                <span class="text-m font-extrabold text-[#5e5c5c] ml-3">{{ tweet.tag }}</span>
            </div>
        <div class="flex items-center justify-between mt-4 w-4/5">
            ...
            <div class="flex">
                <span class="text-xs font-extrabold text-[#5e5c5c] ml-3">{{ tweet.date }}</span>
            </div>
            </div>
        </div>
</template>
